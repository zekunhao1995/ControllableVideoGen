...
datareader = RPReader_traj(is_test=True, max_interval=10, min_ntraj=10, max_ntraj=10, is_eval=True)
...
restore('./snapshots/rp/ckpt_e0_b198000.pth')
test()
