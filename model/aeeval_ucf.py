...
datareader = UCFReader_traj(is_test=True, max_interval=10, min_ntraj=10, max_ntraj=10, is_eval=True)
train_loader = torch.utils.data.DataLoader(
    datareader, batch_size=4, shuffle=False, collate_fn=datareader.collate_fn_eval, worker_init_fn=datareader.worker_init_fn, num_workers=6, pin_memory=True, drop_last = True)
...
restore('./snapshots/ucf/ckpt_e0_b52000_cont.pth')
test()
